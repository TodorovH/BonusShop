export function getBonusesData() {
  return [
    {
      brand: 'cosmoswin',
      id: 'CWS-Welcome',
    ...
    },
    {
      ...
      id: 'CWS-OneTime',
      name: {
        en: 'Cosmos One-Time Deposit',
        ar: 'إيداع كوزموس لمرة واحدة',
      },
      description: {
    ...
    },
    {
      ...
      name: {
        en: 'Newcomer Advantage',
        ar: 'ميزة القادم الجديد',
      },
      description: {
    ...
    },
    {
      ...
      id: 'BTF-OneShot',
      name: {
        en: 'One-Shot Deposit Booster',
        ar: 'تعزيز الإيداع لمرة واحدة',
      },
      description: {
        en: 'Bonus for users with exactly 1 deposit and zero balance.',
        ar: 'مكافأة للمستخدمين الذين لديهم إيداع واحد ورصيد صفر.',
